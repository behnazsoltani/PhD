...
class CIFAR10_truncated(data.Dataset):
    ...
    def __getitem__(self, index):
     ...
     #   img, target = self.data[index], self.target[index]
        ...
        img, target = self.data[index].copy(), self.target[index].copy()
        
        # Check for unintentional modifications
        assert np.array_equal(self.data[index], img), "Data has been modified!"
