...
def load_partition_data_cifar100( data_dir, partition_method, partition_alpha, client_number, batch_size, logger):
    ...
    num_classes = 100 
    full_test_dataset = CIFAR100(root=data_dir, train=False, download=True)
   ...
   # np.random.seed(42)  # Set seed for reproducibility
    ...
    train_data_global, test_data_global = get_dataloader_CIFAR100(data_dir, batch_size, batch_size, test_idxs=selected_test_indices, logger=logger)
